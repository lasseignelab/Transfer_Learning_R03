...
Downloaded dat aon Feb 28, 2022
```{r}
library(readr)
...
```
different order between files. Also some of the ids are not matching between cell line info and PRISM primary screen results. 
```{r}
names_vector<- c()
...
make table files for each cancer
