...
# START 
    ...
    We investigated the centraility of the highest weighted genes from all the latent variables and found that the top 10 highest weighted genes (aka. an important gene for the latent variable) for all the latent variables compared to genes that were not a top gene in any of latent gene were higher across all three centrality metrics 
