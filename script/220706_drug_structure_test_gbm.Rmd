...
# START 
    ...
    Data being used:
   The drug structure data files for the different candidates were accessed via customCMPdb’s loadSDFwithName function for the LINCS dataset (Accessed date: July. 2022). 
