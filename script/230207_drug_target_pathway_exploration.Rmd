...
```{r}
gbm_metadata <- readRDS("~/data/recount3_GBM_GTEx_BRAIN_metadata.rds")
...
for (i in 1:nrow(lincs_deseq2_gbm_res_GI1_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_deseq2_gbm_res_GI1_fda_approved$pert[i], targets, as.data.frame(gbm_tpm_df) , gbm_metadata$status, deseq_results, se= se_asssay, cell_lincs= "__GI1__trt_cp", "~/output/deseq2_gbm/220928_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_limma_gbm_res_GI1_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_limma_gbm_res_GI1_fda_approved$pert[i], targets, as.data.frame(gbm_tpm_df) , gbm_metadata$status, deseq_results, se= se_asssay, cell_lincs= "__GI1__trt_cp", "~/output/limma_gbm/220808_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_tfl_gbm_res_GI1_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_tfl_gbm_res_GI1_fda_approved$pert[i], targets, as.data.frame(gbm_tpm_df) , gbm_metadata$status, deseq_results, se= se_asssay, cell_lincs= "__GI1__trt_cp", "~/output/TF_L_GBM/220808_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_deseq_gbm_res_HEPG2_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_deseq_gbm_res_HEPG2_fda_approved$pert[i], targets, as.data.frame(liver_tpm_df) , liver_metadata$status, LIHC_deseq_results, se= se_asssay, cell_lincs= "__HEPG2__trt_cp", "~/output/liver_cancer/deseq2_res/220602_candidate_plot"))
}
```
...
limma
  drug target pathway analysis  
```{r}
drug_target_sig_search(lincs_limma_gbm_res_HEPG2_fda_approved$pert, "~/output/liver_cancer/limma_res/220808_SR_LINCS_LIHC_limma_PATHWAY.csv", "~/output/liver_cancer/limma_res/220808_SR_LINCS_LIHC_limma_PATHWAY.png" )
```
...
for (i in 1:nrow(lincs_limma_gbm_res_HEPG2_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_limma_gbm_res_HEPG2_fda_approved$pert[i], targets, as.data.frame(liver_tpm_df) , liver_metadata$status, LIHC_deseq_results, se= se_asssay, cell_lincs= "__HEPG2__trt_cp", "~/output/liver_cancer/limma_res/230215_candidate_plot"))
}
```
...
for (i in 1:nrow(lincs_tfl_gbm_res_HEPG2_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_tfl_gbm_res_HEPG2_fda_approved$pert[i], targets, as.data.frame(liver_tpm_df ), liver_metadata$status, LIHC_deseq_results, se= se_asssay, cell_lincs= "__HEPG2__trt_cp", "~/output/liver_cancer/TFL_res/230215_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_deseq_gbm_res_A549_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_deseq_gbm_res_A549_fda_approved$pert[i], targets, as.data.frame(lung_tpm_df) , lung_metadata$status, lung_deseq_results, se= se_asssay, cell_lincs= "__A549__trt_cp", "~/output/lung_cancer/deseq2_res/220929_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_limma_gbm_res_A549_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_limma_gbm_res_A549_fda_approved$pert[i], targets, as.data.frame(lung_tpm_df) , lung_metadata$status, lung_deseq_results, se= se_asssay, cell_lincs= "__A549__trt_cp", "~/output/lung_cancer/limma_res/candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_tfl_gbm_res_A549_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_tfl_gbm_res_A549_fda_approved$pert[i], targets, as.data.frame(lung_tpm_df) , lung_metadata$status, lung_deseq_results, se= se_asssay, cell_lincs= "__A549__trt_cp", "~/output/lung_cancer/TFL_res/candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_deseq_gbm_res_YAPC_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis(lincs_deseq_gbm_res_YAPC_fda_approved$pert[i], targets, as.data.frame(paad_tpm_df) , paad_metadata$status, paad_deseq_results, se= se_asssay, cell_lincs= "__YAPC__trt_cp", "~/output/pancreas_cancer/deseq2_res/230215_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_limma_gbm_res_YAPC_fda_approved ) ){
  ...
  #print(targets)
  try(drug_analysis(lincs_limma_gbm_res_YAPC_fda_approved$pert[i], targets, as.data.frame(paad_tpm_df) , paad_metadata$status, paad_deseq_results, se= se_asssay, cell_lincs= "__YAPC__trt_cp", "~/output/pancreas_cancer/limma_res/230215_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_tfl_gbm_res_YAPC_fda_approved ) ){
  ...
  #print(targets)
  try(drug_analysis(lincs_tfl_gbm_res_YAPC_fda_approved$pert[i], targets, as.data.frame(paad_tpm_df) , paad_metadata$status, paad_deseq_results, se= se_asssay, cell_lincs= "__YAPC__trt_cp", "~/output/pancreas_cancer/TFL_res/230215_candidate_plots"))
}
```
