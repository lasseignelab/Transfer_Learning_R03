...
for (i in 1:nrow(lincs_deseq_gbm_res_HEPG2_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_deseq_gbm_res_HEPG2_fda_approved$pert[i], targets, as.data.frame(liver_tpm_df) , liver_metadata$status, LIHC_deseq_results, se= se_asssay, cell_lincs= "__HEPG2__trt_cp", "~/output/liver_cancer/deseq2_res/220602_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_limma_gbm_res_HEPG2_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_limma_gbm_res_HEPG2_fda_approved$pert[i], targets, as.data.frame(liver_tpm_df) , liver_metadata$status, LIHC_deseq_results, se= se_asssay, cell_lincs= "__HEPG2__trt_cp", "~/output/liver_cancer/limma_res/220602_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_tfl_gbm_res_HEPG2_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis( lincs_tfl_gbm_res_HEPG2_fda_approved$pert[i], targets, as.data.frame(liver_tpm_df ), liver_metadata$status, LIHC_deseq_results, se= se_asssay, cell_lincs= "__HEPG2__trt_cp", "~/output/liver_cancer/TFL_res/220602_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_deseq_gbm_res_YAPC_fda_approved) ){
  ...
  #print(targets)
  try(drug_analysis(lincs_deseq_gbm_res_YAPC_fda_approved$pert[i], targets, as.data.frame(paad_tpm_df) , paad_metadata$status, paad_deseq_results, se= se_asssay, cell_lincs= "__YAPC__trt_cp", "~/output/pancreas_cancer/deseq2_res/220929_candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_limma_gbm_res_YAPC_fda_approved ) ){
  ...
  #print(targets)
  try(drug_analysis(lincs_limma_gbm_res_YAPC_fda_approved$pert[i], targets, as.data.frame(paad_tpm_df) , paad_metadata$status, paad_deseq_results, se= se_asssay, cell_lincs= "__YAPC__trt_cp", "~/output/pancreas_cancer/limma_res/candidate_plots"))
}
```
...
for (i in 1:nrow(lincs_tfl_gbm_res_YAPC_fda_approved ) ){
  ...
  #print(targets)
  try(drug_analysis(lincs_tfl_gbm_res_YAPC_fda_approved$pert[i], targets, as.data.frame(paad_tpm_df) , paad_metadata$status, paad_deseq_results, se= se_asssay, cell_lincs= "__YAPC__trt_cp", "~/output/pancreas_cancer/TFL_res/candidate_plots"))
}
```
