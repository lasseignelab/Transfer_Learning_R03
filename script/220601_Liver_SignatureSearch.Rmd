...
```{r eval=FALSE}
write.csv(hyperG_k_res_v2 , file= "~/output/liver_cancer/deseq2_res/220929_SR_LINCS_LIHC_DESEQ2_PATHWYA.csv" )
```
...
```{r eval=FALSE}
deseq2_lihc_normal <- read.csv( "~/output/liver_cancer/deseq2_res/220929_deseq2_lihc_normal_gtx_res.csv")
deseq2_lihc_normal<- cbind(rownames(deseq2_lihc_normal), deseq2_lihc_normal )
deseq2_lihc_normal$Symbol<- feature_info$gene_name
