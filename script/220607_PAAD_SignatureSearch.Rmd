...
```{r}
saveRDS(count_table_v3, "~/output/pancreas_cancer/paad_count_table_filtered.rds")
saveRDS(all_metadata_v3, "~/output/pancreas_cancer/paad_all_metadata_filtered.rds" )
```
