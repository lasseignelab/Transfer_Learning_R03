...
lincs_deseq2_gbm_res_GI1_fda_approved <- read_csv( "~/output/deseq2_gbm/220427_SR_LINCS_GBM_DESEQ2_RES_all.csv")
...
```{r}
go_term_heatmap(limma_pathways_liver, deseq2_pathways_liver, TFL_pathways_liver, "Up", threshold =0.95)
```
...
down
```{r}
go_term_heatmap(limma_pathways_liver, deseq2_pathways_liver, TFL_pathways_liver, "Down", threshold =0.95)
```
...
```{r}
go_term_heatmap(limma_pathways_lung, deseq2_pathways_lung, TFL_pathways_lung, "Up", threshold =0.80)
```
...
down
```{r}
go_term_heatmap(limma_pathways_lung, deseq2_pathways_lung, TFL_pathways_lung, "Down", threshold =0.90)
```
...
up 
```{r}
go_term_heatmap(limma_pathways_PAAD, deseq2_pathways_PAAD, TFL_pathways_PAAD, "Up", threshold =0.70)
```
...
down
```{r}
go_term_heatmap(limma_pathways_PAAD, deseq2_pathways_PAAD, TFL_pathways_PAAD, "Down", threshold =0.95)
```
